        ...
        <?php if (User::userIsAdmin()) { ?>
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group" id="list">
                                    ...
                                    <label for="form-producer">Режиссёр</label>
                                    <input type="text" class="form-control" id="form-producer"
                                    ...
                                    <label for="film-end-start">Конец проката</label>
                                    <input type="date" class="form-control" id="film-end-start"
                                    ...
                                    <textarea class="form-control" id="film-starring" placeholder="Введите актеров главных ролях..."></textarea>
                                    <label for="film-description">Описание фильма</label>
                                    <textarea class="form-control" id="film-description" placeholder="Введите описание фильма..."></textarea>
                                    <label for="film-trailer">В главных ролях</label>
            ...
            <div class="input-group">
                <select class="custom-select" id="select-essence">
                    <option selected>Выберите что добваить...</option>
                    <option value="1">Сеанс</option>
                    ...
                    <table class="table table-sm">
                        ...
                        <?php foreach ($wishList as $wishFilm): ?>
                            <tr class="table-<?php echo ($wishFilm['is_available'] == '1') ? 'success' : 'primary'; ?>">
                                ...
                                <td>
                                    <button value="film" type="button" id="<?php echo $film['id']; ?>"
                                            class="order-admin-decision btn btn-outline-danger delete">Забронировать
                                    </button>
                                </td>
                                <td>
                                    <button <?php echo ($wishFilm['is_available'] == '1') ? 'disabled ' : ''; ?>
                                            value="film" type="button" id="<?php echo $film['id']; ?>"
                                            class="order-admin-decision btn btn-outline-danger delete">Удалить
                                    </button>
                                </td>
                            </tr>
